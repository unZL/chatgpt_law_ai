...
class gpt_requst:
    def __init__(self, openai_api,openai_completion_config,law_item_require):
        super().__init__()
        # key
        ...
        # require
        self.require_name = law_item_require.require_name
        self.law_text = law_item_require.law_text

    def set_model_by_config(self,model_by_config):
        self.model = model_by_config
...
class gpt_requst_davinci():
    def __init__(self, openai_api,openai_completion_config,law_item_require):
        ...
        # argument
        self.model_davinci_config = openai_completion_config["model_davinci"]
        self.initial_prompt_config = openai_completion_config['initial_prompt']
        self.temperature_config = float(openai_completion_config['temperature'])
        self.max_tokens_config = int(openai_completion_config['max_tokens'])
        self.top_p_config = float(openai_completion_config['top_p'])
    ...
    def use_openai(
        ...
        # 获取参数
        model_config = self.model_davinci_config
        ...
        response = openai.Completion.create(
            model=model_config,
            prompt=initial_prompt_config+prompts,
...
class gpt_requst_turbo:
    def __init__(self, openai_api,openai_completion_config,law_item_require):
        ...
        # argument
        self.model_davinci_config = openai_completion_config["model_turbo"]
        self.initial_prompt_config = openai_completion_config['initial_prompt']
        self.temperature_config = float(openai_completion_config['temperature'])
        self.max_tokens_config = int(openai_completion_config['max_tokens'])
